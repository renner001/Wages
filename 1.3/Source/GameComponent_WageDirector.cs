...
namespace DanielRenner.Wages
{
    public class GameComponent_WageDirector : GameComponent
    {
        ...
        public override void GameComponentTick()
        {
            ...
            if (Find.TickManager.TicksGame % 2500 == 0) // 2500 -> one in-game hour -> every 5 days being 2500*24*5 = 300.000 /*GenTicks.TickRareInterval*/
            {
                ...
                foreach (Pawn pawn in validPawns)
                {
                    ...
                    pawn.needs.mood.thoughts.memories.TryGainMemory((Thought_Memory)ThoughtMaker.MakeThought(DefOfs_Wages.WageLevelEffect, PayHelperUtility.CalcMoodStage(wageOfPawn)));
                }
                if (totalWagesOwed > 0)
                {
